...
Auser = "admin";Apassword = "CD123456"
Buser = "zhangsanmeng";Bpassword = "zhangsanmeng123"
Cuser = "wangwei";Cpassword = "wangwei123"

driver=webdriver.Chrome()
driver.maximize_window()
driver.get("http://192.168.10.216/biz/user-login-L2Jpei8=.html")

driver.find_element_by_id("account").send_keys(Auser)
...
#BUG标题
driver.find_element_by_xpath('//input[@id="title"]').send_keys("服务器无响应7")
#选择严重程度
...
driver.find_element_by_id("account").send_keys(Buser)
...
driver.find_element_by_xpath('//li[@data-id="qa"]').click()
driver.find_element_by_xpath('//li[@data-id="bug"]').click()
driver.find_element_by_xpath('//*[text()="服务器无响应7"]').click()
driver.find_element_by_xpath('//div[@class="btn-toolbar"]/a[3]').click()
time.sleep(1)
...
driver.find_element_by_id("account").send_keys(Cuser)
driver.find_element_by_name("password").send_keys(Cpassword)
time.sleep(1)
driver.find_element_by_id("submit").click()
time.sleep(1)
...
driver.find_element_by_xpath('//li[@data-id="bug"]').click()
driver.find_element_by_xpath('//*[text()="服务器无响应7"]').click()
driver.find_element_by_xpath('//div[@class="btn-toolbar"]/a[4]').click()
time.sleep(1)
driver.switch_to.frame("iframe-triggerModal")
driver.find_element_by_xpath('//div[@id="resolution_chosen"]').click()
time.sleep(1)
driver.find_element_by_xpath('//ul[@class="chosen-results"]/li[@title="已解决"]').click()
driver.find_element_by_xpath('//div[@id="resolvedBuild_chosen"]').click()
time.sleep(1)
driver.find_element_by_xpath('//div[@id="resolvedBuild_chosen"]//div/ul[@class="chosen-results"]/li[@title="V1.2.3"]').click()
time.sleep(1)
driver.find_element_by_xpath('//div[@id="assignedTo_chosen"]').click()
time.sleep(1)
driver.find_element_by_xpath('//div[@class="chosen-drop chosen-auto-max-width chosen-no-wrap in"]/ul/li[@title="Z:张三萌"]').click()
driver.find_element_by_xpath('//button[@id="submit"]').click()
time.sleep(3)
driver.quit()
